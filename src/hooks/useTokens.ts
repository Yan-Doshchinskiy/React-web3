...
const useTokens = (): ITokensAPI => {
  ...
  const [stakingToken, setStakingToken] = useState<IToken>({ ...initialTokenState, address: stakingTokenAddress });
  const [rewardToken, setRewardToken] = useState<IToken>({ ...initialTokenState, address: rewardTokenAddress });
